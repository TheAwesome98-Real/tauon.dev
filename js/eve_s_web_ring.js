...
const renderWebring = () => {
  currentScript.replaceWith(
    e("aside", c("container"), [
      ...
      e("ul", c("site-links"), [
        e("li", c("prev-site"), [e("a", h("https://evescorner.glitch.me/webring.html?number=1"), [t("previous")])]),
        e("li", c("curr-site"), [e("a", h("https://evescorner.glitch.me/webring.html"), [t("all")])]),
        e("li", c("next-site"), [e("a", h("https://evescorner.glitch.me/webring.html?number=3"), [t("next")])]),
      ]),
    ])
  );
};
